...
This application not working yet. A little bit complicated because of the abstract class.
I did some instrospection below.
...
```{r}
abKls <- abstract$class
abKls$getCanonicalName()
```
